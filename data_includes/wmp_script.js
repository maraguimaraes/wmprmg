...
var items = [
  ...
  //Pratica priming
  ["practice4", "FlashSentence", {s: "Carol fez um desenho da sua mãe na escola.", timeout: 6000}, "Question", {q: "Carol desenhou um parente?", hasCorrect:"Sim"}, "Form", {consentRequired: false, continueMessage: "Clique aqui para continuar", html: {include: "p1_img.html"}, timeout:500}, "Question", {q: "A imagem corresponde à sentença que você leu?", hasCorrect: "Não"}],
